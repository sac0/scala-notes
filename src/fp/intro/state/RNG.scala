...
object RNG {
   ...
   * without modifying the state itself. Remember,
  ...
  /**
   * See how this can be mentioned in terms of map
   */
   ...
   * ra and rb, and a function f for combining their results,
 ...
 * The machine has two types of input: you can insert a coin,
 * or you can turn the knob to dispense candy.
 ...
 *
 * The method simulateMachine should operate the machine
 * based on the list of inputs and return the number of
 * coins and candies left in the machine at the end.
