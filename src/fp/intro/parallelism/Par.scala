...
object Par {
   ...
   * It does not use the ExecutorService at all.
   ...
   * using this map2 on them will make them wait. It simply passes the
   ...
   * this implies that we are losing out on some potential parallelism.
